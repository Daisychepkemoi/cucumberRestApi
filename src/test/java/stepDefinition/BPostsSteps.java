...
public class BPostsSteps {
	...
	public void sendAddPost() {
		...
		IRestResponse<PostsR> createnewPost = postsEndPoints.createPost(createPost);
		Response response =createnewPost.getResponse();
	...
	public void sendUpdatePost() {
		...
		IRestResponse<PostsR> updatepost = postsEndPoints.updatePost(updatePost);
